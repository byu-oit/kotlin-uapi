package edu.byu.uapidsl.subresource.single
...
typealias SingleSubCreateOrUpdateHandler<AuthContext, ParentId, ParentModel, SingleSubModel, InputModel> =
        (context: SingleSubCreateOrUpdateContext<AuthContext, ParentId, ParentModel, SingleSubModel, InputModel>) -> Unit

typealias SingleSubDeleteHandler<AuthContext, ParentId, ParentModel, SingleSubModel> =
        (context: SingleSubDeleteContext<AuthContext, ParentId, ParentModel, SingleSubModel>) -> Unit

typealias SingleSubReadHandler<AuthContext, ParentId, ParentModel, SingleSubModel> =
        (context: SingleSubReadLoadContext<AuthContext, ParentId, ParentModel>) -> SingleSubModel?


typealias SingleSubReadAuthorizer<AuthContext, ParentId, ParentModel, SingleSubModel> =
        (context: SingleSubReadContext<AuthContext, ParentId, ParentModel, SingleSubModel>) -> Boolean

typealias SingleSubCreateOrUpdateAuthorizer<AuthContext, ParentId, ParentModel, SingleSubModel, InputModel> =
        (context: SingleSubCreateOrUpdateContext<AuthContext, ParentId, ParentModel, SingleSubModel, InputModel>) -> Boolean

typealias SingleSubDeleteAuthorizer<AuthContext, ParentId, ParentModel, SingleSubModel> =
        (context: SingleSubDeleteContext<AuthContext, ParentId, ParentModel, SingleSubModel>) -> Boolean
