...
private inline fun <reified T : Any> KFunction<*>.expectParam(name: String): KParameter {
    ...
    return found
        ?: throw UAPITypeError.create(this.returnType, "Unable to find '$name' parameter of type '${T::class}' in constructor. The compiler should have caught this error. Try recompiling!")
}
